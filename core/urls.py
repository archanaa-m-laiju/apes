...
urlpatterns = [
    ...
    path("mini-project/srs/", views.srs_submission, name="srs_submission"),
    path("mini-project/sdd/", views.sdd_submission, name="sdd_submission"),
    path("mini-project/literature-review/", views.literature_review_submission, name="literature_review_submission"),
    path("mini-project/srs/download/<int:submission_id>/", views.download_srs_submission, name="download_srs_submission"),
    path("mini-project/sdd/download/<int:submission_id>/", views.download_sdd_submission, name="download_sdd_submission"),
    path("mini-project/literature-review/download/<int:submission_id>/<int:file_number>/", views.download_literature_review_file, name="download_literature_review_file"),
    path("mini-project/literature-review/review/<int:submission_id>/", views.review_literature_review, name="review_literature_review"),
    path("mini-project/srs/review/<int:submission_id>/", views.review_srs_submission, name="review_srs_submission"),
    path("mini-project/sdd/review/<int:submission_id>/", views.review_sdd_submission, name="review_sdd_submission"),
    ...
    path("change-group-leader/<int:group_id>/", views.change_group_leader, name="change_group_leader"),
    # guide-request endpoint is deprecated; coordinator assigns guides directly
    ...
    path("assign-guide/<int:group_id>/", views.assign_guide, name="assign_guide"),
